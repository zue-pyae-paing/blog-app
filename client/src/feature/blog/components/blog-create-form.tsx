...
const BlogCreateForm = () => {
  ...
  return (
    <form className=" relative flex-col py-6 gap-y-3 mb-4 " onSubmit={handleSubmit(onSubmit)}>
      {/* Title */}
      <div className="bg-base-200 p-6 rounded-lg space-y-3 border border-base-300">
        ...
        <p className="text-sm text-base-content">
          Create a compelling headline for your post
        </p>
        <input
          type="text"
          {...register("title")}
      ...
      <button
        ...
        type="submit"
        className="btn btn-accent md:btn-md btn-sm absolute -bottom-6 right-0 flex items-center gap-2 text-white"
      >
        <Send size={20} />
