...
export const getAllCategory = async (req, res, next) => {
  try {
    ...
    const categories = await adminCategoryService.getAllCategory(id,search,limit,page,orderBy);
...
export const getCategoryGrowth = async (req, res, next) => {
  try {
    ...
    const {growthData} = await adminCategoryService.getCategoryGrowth(id, range);
